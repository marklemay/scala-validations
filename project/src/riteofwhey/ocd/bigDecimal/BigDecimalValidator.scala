...
//TODO: Javadoc, basicly https://docs.oracle.com/javase/7/docs/api/java/math/BigDecimal.html#BigDecimal%28java.lang.String%29
  implicit class BigDecimalHelper(val sc: StringContext) extends AnyVal {
    def bd(args: Any*): BigDecimal = macro BigDecimalHelperimpl
  }

  def BigDecimalHelperimpl(c: Context)(args: c.Expr[Any]*): c.Expr[BigDecimal] = {
    import c.universe._
      ...
      case Apply(_, List(Apply(_, rawParts))) =>
        ...
        parts match {
          ...
          case List((raw, pos)) => {
            ...
            reify { BigDecimalRuntime.parse(c.Expr[String] { Literal(Constant(raw)) }.splice) }
